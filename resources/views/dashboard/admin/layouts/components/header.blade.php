            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown nxl-h-item">
                    <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                        <img src="{{ asset('admin/assets/images/avatar/profile-placeholder.jpg') }}" alt="user-image"
                            class="img-fluid user-avtar me-0" />
                    </a>
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('admin/assets/images/avatar/profile-placeholder.jpg') }}"
                                ...
                                <div>
                                    <h6 class="text-dark mb-0">{{ auth()->user()->name }}<span
                                            ...
                                            {{ strtoupper(auth()->user()->role) }}</span></h6>
